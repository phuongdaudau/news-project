@php
    ...
    if(count($items)>0){
        ...
        $xhtmlMenu .= sprintf('<li><a href="%s">%s</a></li>',   route('rss/tin-tuc-tong-hop'), 'Tin tức');
        $xhtmlMenuMobile .= sprintf('<li class="menu_mm"><a href="%s">%s</a></li>',  route('rss/tin-tuc-tong-hop'), 'TTTH');
 
        
        $xhtmlMenu .= sprintf('<li><a href="%s">%s</a></li>',  route('slider'), 'Admin');
                ...
                <div class="col">
                    <div class="header_content d-flex flex-row align-items-center justfy-content-start">
                        <div class="logo_container">
                            <a href="{!! route('home')!!}">
                                <div class="logo"><span>PDD</span>press</div>
                            </a>
                        </div>
