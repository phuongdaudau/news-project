...
@php
    ...
    $sourceValue = array_combine(array_keys(config('phon.template.rss_source')), array_column(config('phon.template.rss_source'), 'name'));
    ...
    $elements = [
        ...
        [
            'label' =>  Form::label('odering', 'Ordering', $formLabelAttr),
            'element' => Form::number('odering', $item['odering']?? null, $formInputAttr)
        ],
        [
            'label' =>  Form::label('source', 'Source', $formLabelAttr),
            'element' => Form::select('source', $sourceValue, $item['source']?? null, $formInputAttr)
        ],
        [
